...
describe("contract", () => {
    ...
    it("should transfer successfully", async () => {
        ...
        expect(receiverWalletDataAfterTransfer.balance).toEqual(transferAmount / 2n); // check that the receiver received the right amount of tokens
        // console.log(receiverWalletDataAfterTransfer.balance);

        const balance1 = await receiverWallet.getGetTonBalance();
